  ...
  return (
    <>
        <main className='bg-slate-50 p-10'>
            <div class="w-full max-w-7xl rounded bg-white p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                <div class="md:flex items-center -mx-10">
                    <div class="w-full md:w-1/2 px-10">
                        <div class="mb-10">

                            <div class="w-full p-4 bg-white rounded-lg sm:p-8 dark:border-gray-700">
                                <h5 class="mb-2 text-3xl font-bold">Download Our App</h5>
                                <p class="mb-5 text-base">Let us design or remodel your
                    ...
                    <div class="w-full md:w-1/2 mb-10 md:mb-0">
                        <div class="p-5">
                            <img src="/download.png" class="md:w-[686px] md:h-[379px]" alt="" />
                        </div>
                    </div>
                </div>
            </div>
