        ...
        <nav className="sticky top-0 z-50">
            ...
            <div
                ...
                <div className="text-center pt-2 flex flex-col items-center mt-3">
                    ...
                    <div className="md:flex md:space-y-0 sm:space-x-4 mb-10">
                        <a href={`${app && app.mac_app_link}`} target='_blank'
                            className="bg-gray-800 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-2 py-[5px] mr-2 dark:bg-gray-700 dark:hover:bg-orange-500 dark:focus:ring-gray-700">
                            <svg className="mr-1 w-2 h-2" aria-hidden="true" focusable="false" data-prefix="fab"
                            ...
                            <div className="text-left">
                                <div className="font-sans text-[8px] font-semibold">App Store</div>
                            </div>
                        </a>

                        <a href={`${app && app.apk_app_link}`} target='_blank'
                            className="bg-gray-800 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-2 py-[5px] dark:bg-gray-700 dark:hover:bg-orange-500 dark:focus:ring-gray-700">
                            <svg className="mr-1 w-2 h-2" aria-hidden="true" focusable="false" data-prefix="fab"
                            ...
                            <div className="text-left">
                                <div className="font-sans text-[8px] font-semibold">Play Store</div>
                            </div>
                        </a>
