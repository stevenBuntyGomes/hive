    ...
    <>
        <main className='bg-slate-50 p-10'>
            <div class="text-center">
                <h5 class="text-orange-500 uppercase font-bold md:text-[32px] text-2xl">OUR TESTIMONIALS</h5>
                <h4 class="font-bold uppercase md:text-[42px] text-4xl py-5">WHAT IS OUR CLIENTS SAY?</h4>
                <p class="">We offer a wide range of plumbing services catered to both residential and commercial clients. Even
            ...
            >
                {contents && contents.map((content, index) => (
                    <SwiperSlide className="py-10" key = {index}>
                        <div className="shadow-[0_0_15px_2px_rgba(0,0,0,0.3)] border-2 border-orange-500 hover:border-blue-500 md:w-[370px] rounded-xl rounded-md">
                            <div class="p-4 flex items-center space-x-4">
                                <div class="flex-shrink-0">
                                    <img class="w-16 h-16 rounded-full" src={content.img} alt="Neil image"/>
                                </div>
