                        ...
                        <div data-aos = "fade-up" className="shadow-[0_0_15px_2px_rgba(0,0,0,0.3)] border-2 border-orange-500 md:max-w-[370px] rounded-xl">
                            <div className="p-4 flex items-center space-x-4">
                                <div className="flex-shrink-0">
                                    <img className="w-16 h-16 rounded-full" src={`${TESTIMONIAL_IMAGE_URL}${testimonial && testimonial.image}`} alt="Neil image"/>
                                </div>
                                <div className="flex-1 min-w-0 mt-5">
                                    ...
                                    <div className="flex items-center mt-2.5 mb-5">
                                        {testimonial && Array(testimonial.rating).fill().map((_, i) => (
                                             <svg key = {i} aria-hidden="true" className="w-5 h-5 text-yellow-300" fill="currentColor"
